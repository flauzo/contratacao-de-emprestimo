...
@REM em relação à propriedade de direitos autorais. O ASF licencia este arquivo
...
@REM KIND, expresso ou implícito. Veja a Licença do
Linguagem específica do 
@REM que rege permissões e limitações
@REM sob a licença.
@REM ----------------------------------------------------------------------------
...
@REM
@REM Variações ENV necessárias:
@REM JAVA_HOME - location of a JDK home dir
@REM
@REM Variações ENV opcionais
...
@REM pause o script se MAVEN_BATCH_PAUSE está configurado para 'on'
